...
using Shouldly;
using Xunit;
using DataSolutions.TransactionExchangeCentre.Sessions;

namespace DataSolutions.TransactionExchangeCentre.Tests.Sessions
{
    public class SessionAppService_Tests : TransactionExchangeCentreTestBase
    {
